...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.create_page') ,
                array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">

            <a href="{{route('page.index') . '?language=' . request()->input('language')}}"
                class="btn btn-primary btn-back">{{clean( trans('niva-backend.back_pages') , array('Attr.EnableID' =>
                true))}}</a>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <strong>{{clean( trans('niva-backend.link') , array('Attr.EnableID' =>
                                                true))}}</strong>
                                            <div class="slug-container"><span>{{URL::to('/')}}/</span><input type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="body" class="form-control" id="body"
                                        rows="5">{{clean( $page->body , array('Attr.EnableID' => true))}}</textarea>
                                </div>
