...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.all_sliders') , array('Attr.EnableID' => true))}}
    </h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.all_sliders') ,
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <a href="{{route('slider.create') . '?language=' . request()->input('language')}}"
                            class="btn btn-primary btn-back">{{clean( trans('niva-backend.create_slider') ,
                            array('Attr.EnableID' => true))}}</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img height="100"
                                        ...
                                        alt="">
                                    <p class="mb-0 mt-2"><a
                                            href="{{ route('slider.edit', $slider->id) . '?language=' . request()->input('language')}}">{{clean(
