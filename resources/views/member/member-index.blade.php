...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.all_members') , array('Attr.EnableID' => true))}}
    </h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.all_members') ,
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <a href="{{route('member.create')}}" class="btn btn-primary btn-back">{{clean(
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img height="100"
                                        ...
                                        alt="">
                                    <p class="mb-0 mt-2"><a href="{{ route('member.edit', $member->id) }}">{{clean(
