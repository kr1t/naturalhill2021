...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.all_media') ,
                array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">

                <a href="{{route('media.create')}}" class="btn btn-primary btn-back">{{clean(
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="url-clip" class="form-control" id="copy-clip{{$photo->id}}"
                                        value="{{url('/')}}/images/media/{{$photo->file}}" readonly="">
                                    <a class="btn btn-primary" onclick="copy_clip{{$photo->id}}()">{{clean(
                                        trans('niva-backend.copy_url') , array('Attr.EnableID' => true))}}</a>
                                </td>
