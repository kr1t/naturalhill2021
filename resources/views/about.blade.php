...
<div class="breadcrumb-area">
    ...
    <ul class="page-list">
        <li class="item-home"><a class="bread-link" href="{{ route('home') }}"
                title="Home">{{$aboutsetting->breadcrumbs_anchor}}</a></li>
                ...
                <div class="venor-team">
                    <div class="thumbnail">
                        <img width="350" height="350" class="lazy img-fluid" src="/public/img/loading-blog.gif"
                            data-src="{{$member->photo ? '/images/media/' . $member->photo->file : '/public/img/200x200.png'}}"
                            alt="team-venor">
                    </div>
                    <div class="content">
        ...
        <div class="clients-slider owl-carousel">
            ...
            <div class="clients-slide">
                <a title="{{$client->company_name}}" target="_blank" href="{{$client->company_link}}"><img
                        ...
                        data-src="{{$client->photo ? '/images/media/' . $client->photo->file : '/public/img/200x200.png'}}"
