...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.all_languages') , array('Attr.EnableID' => true))}}
    </h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.all_languages') ,
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="{{route('language.create')}}" class="btn btn-primary btn-back">{{clean(
                            trans('niva-backend.create_language') , array('Attr.EnableID' => true))}}</a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="language-name" data-label="Name">
                                    <div class="float-left-language-name">
                                        <p>{{$language->name}}</p>
                                        <a href="{{ route('language.edit', $language->id)}}">{{clean(
                                            trans('niva-backend.edit') , array('Attr.EnableID' => true))}}</a>
                                    </div>
                                </td>
