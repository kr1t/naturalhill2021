...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.edit') , array('Attr.EnableID' =>
        true))}}</h6>
    </div>
    <div class="card-body">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="on_off_sublanguage1"> {{clean( trans('niva-backend.yes') ,
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="on_off_sublanguage0"> {{clean( trans('niva-backend.no') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>
