...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.title_log_favicon') , array('Attr.EnableID' => true))}}
  </h1>
  <!-- DataTales Example -->
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <img style="padding-bottom:10px" class="img-fluid" width="50"
                    src="/images/media/{{$setting->photo ? $setting->photo->file : '/public/img/200x200.png'}}" alt="">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  <strong>{{clean( trans('niva-backend.favicon') , array('Attr.EnableID' => true))}}
                    ...
                    <span>{{clean( trans('niva-backend.upload_image') , array('Attr.EnableID' => true))}} <a
                        target="_blank" href="{{route('media.create')}}"> {{clean( trans('niva-backend.here') ,
                        array('Attr.EnableID' => true))}} </a> {{clean( trans('niva-backend.then_copy_url') ,
                      array('Attr.EnableID' => true))}} <a target="_blank" href="{{route('media.index')}}"> {{clean(
                        trans('niva-backend.here') , array('Attr.EnableID' => true))}} </a></span>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="OGgraph_switch1"> {{clean( trans('niva-backend.on') ,
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="OGgraph_switch0"> {{clean( trans('niva-backend.off') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="analytics_switch" id="analytics_switch1"
                      value="1" @if($setting->analytics_switch == 1) checked @endif>
                    <label class="form-check-label" for="analytics_switch1"> {{clean( trans('niva-backend.on') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="analytics_switch" id="analytics_switch0"
                      value="0" @if($setting->analytics_switch == 0) checked @endif>
                    <label class="form-check-label" for="analytics_switch0"> {{clean( trans('niva-backend.off') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="facebook_pixel_switch" id="pixel_switch1"
                      value="1" @if($setting->facebook_pixel_switch == 1) checked @endif>
                    <label class="form-check-label" for="pixel_switch1"> {{clean( trans('niva-backend.on') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="facebook_pixel_switch" id="pixel_switch0"
                      value="0" @if($setting->facebook_pixel_switch == 0) checked @endif>
                    <label class="form-check-label" for="pixel_switch0"> {{clean( trans('niva-backend.off') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="schema_switch1"> {{clean( trans('niva-backend.on') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="schema_switch0"> {{clean( trans('niva-backend.off') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <strong>{{clean( trans('niva-backend.contact_address') , array('Attr.EnableID' =>
                        true))}}</strong>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  <strong>{{clean( trans('niva-backend.enable_disable_whatsapp') , array('Attr.EnableID' =>
                    true))}}</strong>
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="enable_disable_whatsapp1"> {{clean( trans('niva-backend.on') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="enable_disable_whatsapp0"> {{clean( trans('niva-backend.off') ,
                      array('Attr.EnableID' => true))}} </label>
                  </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <textarea data-editor="css" name="custom_css" class="form-control" id="custom_css" data-gutter="1"
                    rows="10">{{$setting->custom_css}}</textarea>
                </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  <textarea data-editor="javascript" name="custom_js" class="form-control" id="custom_js"
                    data-gutter="1" rows="10">{{$setting->custom_js}}</textarea>
                </div>
              </div>
