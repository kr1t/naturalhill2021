...
<div class="breadcrumb-area">
	<h1 class="breadcrumb-title">{{clean( trans('niva-backend.you_searched_for') , array('Attr.EnableID' => true))}}
		{{$term}}</h1>
</div>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="projects projects-page row">
						...
						<div class="project-inner">
							<div class="project-thumbnail">
								<a href="{{URL::to('/')}}/project/{{$project->slug}}" title=""><img width="400"
										height="250" src="/public/img/loading-blog.gif"
										data-src="{{$project->photo ? '/images/media/' . $project->photo->file : '/public/img/200x200.png'}}"
										class="lazy img-fluid" alt="{{$project->title}}"></a>
							</div>
					...
					@else
					<div>
						<h4 class="no-results">{{clean( trans('niva-backend.no_results') , array('Attr.EnableID' =>
							true))}}</h4>
					</div>
					@endif
