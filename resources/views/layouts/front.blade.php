...
<head>
    ...
    <meta itemprop="image" content="{{route('home')}}{{$setting->photo ? '/images/media/' . $setting->photo->file : '/public/img/200x200.png'}}">
    ...
    <meta property="og:image" content="{{route('home')}}{{$setting->photo ? '/images/media/' . $setting->photo->file : '/public/img/200x200.png'}}" />
...
<body class="common-front @if($currentLang->rtl == 1) rtl @endif" @if($currentLang->rtl == 1) dir="rtl" @endif>
        ...
        <div class="header__content__venor">
            <div class="header__logo">
                <a href="{{url('/')}}" title="{{$setting->title}}">
                    <img width="105" height="22" class="img-fluid logo-front" src="{{$setting->photo ? '/images/media/' . $setting->photo->file : '/public/img/200x200.png'}}" alt="logo">
                </a>
            </div>
                ...
                <div class="header__lang">
                    ...
                    @if (!empty($currentLang) && count($langs) > 1)
                        ...
                        <a class="header__lang-btn" href="#" role="button" id="dropdownLang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img width="16" height="16" src="{{$currentLang->photo ? '/images/media/' . $currentLang->photo->file : '/public/img/200x200.png'}}" alt="flag">
    ...
    <div class="hidden"  itemscope="" itemtype="https://schema.org/LocalBusiness">
        ...
        <img src="{{route('home')}}{{$setting->photo ? '/images/media/' . $setting->photo->file : '/public/img/200x200.png'}}" alt="logo" width="120" itemprop="url"></div>
