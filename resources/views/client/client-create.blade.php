...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.create_client') , array('Attr.EnableID' => true))}}
    </h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.create_client') ,
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{route('nearby.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <strong>{{clean( trans('niva-backend.company_name') , array('Attr.EnableID' =>
                                        true))}}</strong>
                                    <input type="text" name="company_name" class="form-control" placeholder="">
                                </div>
                                <div class="form-group">
                                    <strong>{{clean( trans('niva-backend.company_link') , array('Attr.EnableID' =>
                                        true))}}</strong>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 text-right">
                                <button type="submit" class="btn btn-primary">{{clean( trans('niva-backend.create') ,
