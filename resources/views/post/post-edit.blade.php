...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.edit_article') , array('Attr.EnableID' => true))}}
    </h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.edit_article') ,
                array('Attr.EnableID' => true))}}</h6>
        </div>
        <div class="card-body">

            <a href="{{route('post.index') . '?language=' . request()->input('language')}}"
                class="btn btn-primary btn-back">{{clean( trans('niva-backend.back_blogpage') , array('Attr.EnableID' =>
                true))}}</a>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="slug-container"><span>{{URL::to('/')}}/{{clean(
                                                    trans('niva-backend.post') , array('Attr.EnableID' =>
                                                    true))}}/</span><input type="text" name="slug" class="form-control"
                                                    placeholder="" value="{{$post->slug}}"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" id="category_id" class="form-control">
                                                ...
                                                <option @if($post->category_id == $category->id) { selected="selected" }
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="body" class="form-control" id="body"
                                        rows="20">{{clean( $post->body , array('Attr.EnableID' => true))}}</textarea>
                                </div>
