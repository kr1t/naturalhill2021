...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">{{clean( trans('niva-backend.section_7_blog') , array('Attr.EnableID' => true))}}
    </h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{clean( trans('niva-backend.section_7_blog') ,
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <a href="{{route('blog-setting.edit') . '?language=' . request()->input('language')}}"
                            class="btn btn-primary btn-back">{{clean( trans('niva-backend.back_blogpage') ,
                            array('Attr.EnableID' => true))}}</a>
                        @endif
                        <a href="{{route('post.create') . '?language=' . request()->input('language')}}"
                            class="btn btn-primary btn-back">{{clean( trans('niva-backend.create_article') ,
                            array('Attr.EnableID' => true))}}</a>
                    </div>
                    <div class="col-lg-6 text-right">
                        ...
                        <select name="language" class="form-control language-control"
                            ...
                            <option value="" selected disabled>{{clean( trans('niva-backend.select_language') ,
                                array('Attr.EnableID' => true))}}</option>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">{{clean( trans('niva-backend.id') , array('Attr.EnableID' => true))}}
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Photo"><img height="50"
                                        ...
                                        alt="">
                                    <p class="mb-0 mt-2"><a
                                            href="{{ route('post.edit', $post->id) . '?language=' . request()->input('language')}}">{{clean(
                                ...
                                <td data-label="Category">{{$post->category ? $post->category->name : 'Uncategorized'}}
                                </td>
