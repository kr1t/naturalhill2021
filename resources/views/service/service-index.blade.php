                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="{{route('home-setting.edit') .  '?language=' . request()->input('language')}}"
                            class="btn btn-primary btn-back">Back to home</a>
                        <a href="{{route('service.create') . '?language=' . request()->input('language')}}"
                            class="btn btn-primary btn-back">Create service</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img height="100"
                                        ...
                                        alt="">
                                    <p class="mb-0 mt-2"><a
                                            href="{{ route('service.edit', $service->id) . '?language=' . request()->input('language') }}">{{clean(
